...
\address{Centre Inria d'Université Côte d'Azur, Sophia Antipolis, France}
\position{Curriculum Vitae}
% \mobile{(+33) 6 25 87 87 79}
\email{emilie.yu@inria.fr}
\homepage{em-yu.github.io}
\github{em-yu}
%\linkedin{posquit0}
% \gitlab{gitlab-id}
...
% \quote{Looking for a research internship in the field of computer graphics, from February 2020}
